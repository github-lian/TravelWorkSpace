...
public class AllGroupAdapter extends BaseAdapter {
    private List<GroupBean> MsgList;
    private View view;
    private Context mContext;
    private AllGroupAdapter.ViewHolder viewHolder;

    public AllGroupAdapter(Context mContext, List<GroupBean> MsgList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            view = convertView;
            viewHolder = (AllGroupAdapter.ViewHolder) view.getTag();
        }
