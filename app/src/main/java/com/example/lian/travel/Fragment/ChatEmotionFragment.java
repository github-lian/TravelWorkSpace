...
import com.example.lian.travel.Adapter.EmotionGridViewAdapter;
import com.example.lian.travel.Adapter.EmotionPagerAdapter;
import com.example.lian.travel.R;
import com.example.lian.travel.Util.BaseFragment;
import com.example.lian.travel.Util.EmotionUtils;
import com.example.lian.travel.Util.GlobalOnItemClickManagerUtils;
import com.example.lian.travel.Util.MapApplication;
import com.example.lian.travel.Util.Utils;
import com.example.lian.travel.widget.IndicatorView;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = MapApplication.screenWidth;
        // item的间距
